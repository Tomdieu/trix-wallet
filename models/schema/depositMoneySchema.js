...
const depostiMoneySchema = {
  reciever: {
    notEmpty: true,
    errorMessage:'reciever account number require',
    custom: {
          ...
          if (acc_num) {
            ...
            if (user_account) {
              ...
              if (user_account.user_id === user.id) {
                return Promise.reject("You can't deposit money to your self");
              }
            } else {
...
module.exports = checkSchema(depostiMoneySchema);
